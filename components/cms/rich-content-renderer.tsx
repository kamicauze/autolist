  ...
  return (
    <div
      className={cn(
        ...
        "[&_a]:font-semibold [&_a]:text-[#2563eb] [&_a]:underline [&_a]:underline-offset-4",
        "[&_blockquote]:border-l-4 [&_blockquote]:border-[#dbe8ff] [&_blockquote]:bg-[#f7faff] [&_blockquote]:px-4 [&_blockquote]:py-3 [&_blockquote]:text-[#475467]",
