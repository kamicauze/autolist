...
export const ADMIN_NAV_SECTIONS: AdminNavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Reports", href: "/admin/reports", icon: ScrollText, badge: 7 },
      { name: "Verification (KYC)", href: "/admin/verification", icon: ShieldCheck, badge: 23 },
      { name: "Insurance Requests", href: "/admin/insurance-requests", icon: ReceiptText, badge: 3 },
      { name: "Car Inquiries", href: "/admin/car-inquiries", icon: MessageSquareText, badge: 23 },
      { name: "Payments", href: "/admin/payments", icon: CircleDollarSign, badge: 23 },
    ],
  },
  {
