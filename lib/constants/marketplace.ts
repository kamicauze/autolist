...
const CAR_FEATURE_ID_OVERRIDES: Record<string, string> = {
  ...
  "Emergency Call System (SOS)": "emergency_call_system_ecall_sos",
  "Parking Sensors (Front / Rear)": "tech_parking_sensors",
};

const CAR_FEATURE_ALIASES: Record<string, readonly string[]> = {
  "Air Ioniser/Purifier": ["Air Ioniser / Air Purifier", "Air Purifier"],
  ...
  "Auto Dimming Rear View Mirror": ["Auto-Dimming Rear View Mirror"],
  "Digital Dashboard/Virtual Cockpit": ["Digital Dashboard / Virtual Cockpit", "Virtual Cockpit"],
  "Digital Key(Phone-As-Key)": ["Digital Key (Phone-as-Key)", "Phone-as-Key"],
  "Emergency Call System (SOS)": ["Emergency Call System (eCall / SOS)", "eCall", "SOS"],
  "Wireless Apple CarPlay": ["Apple CarPlay Wireless"],
  "Wireless Android Auto": ["Android Auto Wireless"],
};

const CAR_FEATURE_GROUP_OVERRIDES: Record<string, ListingFeatureGroupKey> = {
  "Active Head Restraints": "technology_driver_assist",
  "Cross Traffic Alert": "technology_driver_assist",

  "Emergency Call System (SOS)": "safety",
  "Fire Extinguisher": "safety",
  Flare: "safety",
  "Full Size Spare Wheel": "safety",
  "Space Saver Spare Wheel": "safety",
  "Steering Lock": "safety",
  "Tire Repair Kit": "safety",
  "Vehicle Tracking": "safety",
  "Warning Triangle": "safety",
  "Wheel Lock": "safety",

  Radio: "infotainment",

  "CD Player": "audio_visual",
  "DVD Player": "audio_visual",
  "Rear Entertainment Screens": "audio_visual",

  "Alcantara/Suede Seats": "interior",
  "Auto Dimming Rear View Mirror": "interior",
  "Cloth Seats": "interior",
  "Digital Dashboard/Virtual Cockpit": "interior",
  "Third Row Seats": "interior",

  "Alloy Wheels": "exterior",
  Canopy: "exterior",
  "Deployable Side Steps": "exterior",
  "Fixed Side Steps": "exterior",
  "Headlight Washers": "exterior",
  "Illuminated Grill": "exterior",
  "Mud Guards": "exterior",
  "Rear Spoiler": "exterior",
  "Roof Racks": "exterior",
  "Roof Rails": "exterior",
  "Tonneau Cover": "exterior",
  "Tow Hook": "exterior",
  "Wheel Caps": "exterior",
  "Wind Deflectors": "exterior",

  "Active Noise Cancellation": "comfort_convenience",
  "Air Ioniser/Purifier": "comfort_convenience",
  "Cool Box": "comfort_convenience",
  "Digital Key(Phone-As-Key)": "comfort_convenience",
  "Gesture Control": "comfort_convenience",
  "Lumbar Support": "comfort_convenience",
  "Remote Engine Start": "comfort_convenience",
  "Tinted Windows": "comfort_convenience",
  "Vehicle Locator": "comfort_convenience",
  "Wireless Charging": "comfort_convenience",

  "Sports Exhaust": "performance_mechanical",
};
...
function buildFeatureDefinitions(
  ...
  groupOverrides?: Record<string, ListingFeatureGroupKey>
  ...
  return labels.map((label) => {
    ...
    return {
      id,
      label,
      group: groupOverrides?.[label] ?? inferGroup(label),
...
const CAR_FEATURE_DEFINITIONS = dedupeFeatureDefinitions(
  buildFeatureDefinitions(
    GLOBAL_CAR_FEATURE_LABELS,
    inferCarVanTruckGroup,
    CAR_FEATURE_ID_OVERRIDES,
    CAR_FEATURE_ALIASES,
    CAR_FEATURE_GROUP_OVERRIDES
  )
);
