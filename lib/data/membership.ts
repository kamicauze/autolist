...
export const SELLER_PACKAGE_PLANS: SellerPackagePlan[] = [
  {
    ...
    periodLabel: "/month",
    listingLimit: 15,
    features: ["Up to 15 active vehicles", "Up to 10 photos per listing", "Basic dealer profile", "Basic lead analytics"],
  },
  {
    id: "professional",
    name: "Professional",
    ...
    periodLabel: "/month",
    listingLimit: 80,
    features: ["Up to 80 active vehicles", "Up to 30 photos per listing", "Branded dealer profile", "Advanced lead analytics"],
  },
  {
    id: "enterprise",
    name: "Enterprise",
    ...
    periodLabel: "/month",
    listingLimit: null,
    features: ["Unlimited active vehicles", "Up to 50 photos per listing", "Custom-branded dealer profile", "Dedicated account support"],
  },
];
